...
export declare namespace ReceiveTranscription {
    type Raw = SessionStartedPayload.Raw | PartialTranscriptPayload.Raw | CommittedTranscriptPayload.Raw | CommittedTranscriptWithTimestampsPayload.Raw | CommittedTranscriptEntitiesPayload.Raw | ScribeWarning.Raw | ScribeErrorPayload.Raw | ScribeAuthErrorPayload.Raw | ScribeQuotaExceededErrorPayload.Raw | ScribeThrottledErrorPayload.Raw | ScribeUnacceptedTermsErrorPayload.Raw | ScribeRateLimitedErrorPayload.Raw | ScribeQueueOverflowErrorPayload.Raw | ScribeResourceExhaustedErrorPayload.Raw | ScribeSessionTimeLimitExceededErrorPayload.Raw | ScribeInputErrorPayload.Raw | ScribeInvalidRequestError.Raw | ScribeChunkSizeExceededErrorPayload.Raw | ScribeInsufficientAudioActivityErrorPayload.Raw | ScribeTranscriberErrorPayload.Raw;
}
