...
export declare const DocumentRefreshResponse: core.serialization.Schema<serializers.conversationalAi.knowledgeBase.DocumentRefreshResponse.Raw, ElevenLabs.conversationalAi.knowledgeBase.DocumentRefreshResponse>;
export declare namespace DocumentRefreshResponse {
    type Raw = DocumentRefreshResponse.Url | DocumentRefreshResponse.File | DocumentRefreshResponse.Text | DocumentRefreshResponse.Folder;
