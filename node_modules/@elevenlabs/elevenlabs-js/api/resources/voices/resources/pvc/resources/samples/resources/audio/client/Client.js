    ...
    __get(voice_id_1, sample_id_1) {
        return __awaiter(this, arguments, void 0, function* (voice_id, sample_id, request = {}, requestOptions) {
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, `v1/voices/pvc/${core.url.encodePathParam(voice_id)}/samples/${core.url.encodePathParam(sample_id)}/audio`),
                method: "GET",
                headers: _headers,
