...
export declare class DocumentsClient {
     ...
     *     })
     */
    getBulkAgents(request: ElevenLabs.conversationalAi.knowledgeBase.BodyGetDependentAgentsForMultipleDocumentsV1ConvaiKnowledgeBaseDependentAgentsPost, requestOptions?: DocumentsClient.RequestOptions): core.HttpResponsePromise<ElevenLabs.GetKnowledgeBaseDependentAgentsResponseModel>;
    private __getBulkAgents;
    /**
     ...
     *     })
     */
    bulkDelete(request: ElevenLabs.conversationalAi.knowledgeBase.BodyBulkDeleteKnowledgeBaseDocumentsV1ConvaiKnowledgeBaseBulkDeletePost, requestOptions?: DocumentsClient.RequestOptions): core.HttpResponsePromise<Record<string, ElevenLabs.conversationalAi.knowledgeBase.DocumentsBulkDeleteResponseValue>>;
    private __bulkDelete;
}
