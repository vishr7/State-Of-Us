...
export declare const KnowledgeBaseContentSearchResultDocument: core.serialization.Schema<serializers.KnowledgeBaseContentSearchResultDocument.Raw, ElevenLabs.KnowledgeBaseContentSearchResultDocument>;
export declare namespace KnowledgeBaseContentSearchResultDocument {
    type Raw = KnowledgeBaseContentSearchResultDocument.File | KnowledgeBaseContentSearchResultDocument.Folder | KnowledgeBaseContentSearchResultDocument.Text | KnowledgeBaseContentSearchResultDocument.Url;
