...
export declare namespace PhoneNumbersListResponseItem {
    type Raw = PhoneNumbersListResponseItem.Twilio | PhoneNumbersListResponseItem.Exotel | PhoneNumbersListResponseItem.SipTrunk;
    interface Twilio extends GetPhoneNumberTwilioResponseModel.Raw {
        provider: "twilio";
    }
    interface Exotel extends GetPhoneNumberExotelResponseModel.Raw {
        provider: "exotel";
    }
