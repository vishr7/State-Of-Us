...
export declare namespace AuthConnectionsUpdateResponse {
    type Raw = AuthConnectionsUpdateResponse.Oauth2ClientCredentials | AuthConnectionsUpdateResponse.RefreshTokenAuth | AuthConnectionsUpdateResponse.BasicAuth | AuthConnectionsUpdateResponse.BearerAuth | AuthConnectionsUpdateResponse.Oauth2Jwt | AuthConnectionsUpdateResponse.PrivateKeyJwt | AuthConnectionsUpdateResponse.Mtls | AuthConnectionsUpdateResponse.CustomHeaderAuth | AuthConnectionsUpdateResponse.ApiIntegrationOauth2AuthCode | AuthConnectionsUpdateResponse.ApiIntegrationOauth2CustomApp | AuthConnectionsUpdateResponse.WhatsappAuth | AuthConnectionsUpdateResponse.SlackBotAuth | AuthConnectionsUpdateResponse.UrlSecret;
    interface Oauth2ClientCredentials extends OAuth2ClientCredsResponse.Raw {
        auth_type: "oauth2_client_credentials";
    }
    interface RefreshTokenAuth extends RefreshTokenAuthResponse.Raw {
