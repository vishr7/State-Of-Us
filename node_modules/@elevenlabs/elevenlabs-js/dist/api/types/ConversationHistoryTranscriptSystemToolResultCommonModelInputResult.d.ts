...
export declare namespace ConversationHistoryTranscriptSystemToolResultCommonModelInputResult {
    ...
    interface EndProcedureError extends ElevenLabs.EndProcedureToolResultErrorModel {
        resultType: "end_procedure_error";
    }
    interface EndProcedureSuccess extends ElevenLabs.EndProcedureToolResultSuccessModel {
    ...
    interface StartProcedureError extends ElevenLabs.StartProcedureToolResultErrorModel {
        resultType: "start_procedure_error";
    }
    interface StartProcedureSuccess extends ElevenLabs.StartProcedureToolResultSuccessModel {
