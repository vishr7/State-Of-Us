...
class VoicesClient {
    ...
    __search() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            var _a, _b, _c, _d, _e, _f, _g, _h, _j, _k, _l, _m, _o, _p;
            const { nextPageToken, pageSize, search, sort, sortDirection, voiceType, category, fineTuningState, collectionId, gender, age, language, accent, useCases, minNoticePeriodDays, includeCustomRates, includeLiveModerated, highQuality, includeTotalCount, voiceIds, } = request;
            const _queryParams = {
