    ...
    __create(voice_id, request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_g = this._options.fetcher) !== null && _g !== void 0 ? _g : core.fetcher)({
                url: core.url.join((_j = (_h = (yield core.Supplier.get(this._options.baseUrl))) !== null && _h !== void 0 ? _h : (yield core.Supplier.get(this._options.environment))) !== null && _j !== void 0 ? _j : environments.ElevenLabsEnvironment.Production, `v1/voices/pvc/${core.url.encodePathParam(voice_id)}/samples`),
                method: "POST",
                headers: _headers,
    ...
    __update(voice_id_1, sample_id_1) {
        return __awaiter(this, arguments, void 0, function* (voice_id, sample_id, request = {}, requestOptions) {
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, `v1/voices/pvc/${core.url.encodePathParam(voice_id)}/samples/${core.url.encodePathParam(sample_id)}`),
                method: "POST",
                headers: _headers,
                contentType: "application/json",
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
                requestType: "json",
                body: (0, requestBody_1.mergeAdditionalBodyParameters)(serializers.voices.pvc.BodyUpdatePvcVoiceSampleV1VoicesPvcVoiceIdSamplesSampleIdPost.jsonOrThrow(request, { unrecognizedObjectKeys: "strip" }), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.additionalBodyParameters),
