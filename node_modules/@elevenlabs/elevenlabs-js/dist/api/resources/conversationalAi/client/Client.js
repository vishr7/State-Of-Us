...
const Client_17 = require("../resources/triageTickets/client/Client");
const Client_18 = require("../resources/twilio/client/Client");
const Client_19 = require("../resources/users/client/Client");
const Client_20 = require("../resources/whatsapp/client/Client");
const Client_21 = require("../resources/whatsappAccounts/client/Client");
class ConversationalAiClient {
    ...
    get twilio() {
        var _a;
        return ((_a = this._twilio) !== null && _a !== void 0 ? _a : (this._twilio = new Client_18.TwilioClient(this._options)));
    }
    get exotel() {
        var _a;
    ...
    get whatsapp() {
        var _a;
        return ((_a = this._whatsapp) !== null && _a !== void 0 ? _a : (this._whatsapp = new Client_20.WhatsappClient(this._options)));
    }
    get agents() {
        var _a;
    ...
    get users() {
        var _a;
        return ((_a = this._users) !== null && _a !== void 0 ? _a : (this._users = new Client_19.UsersClient(this._options)));
    }
    get triageTickets() {
        var _a;
        return ((_a = this._triageTickets) !== null && _a !== void 0 ? _a : (this._triageTickets = new Client_17.TriageTicketsClient(this._options)));
    }
    get phoneNumbers() {
        var _a;
    ...
    get whatsappAccounts() {
        var _a;
        return ((_a = this._whatsappAccounts) !== null && _a !== void 0 ? _a : (this._whatsappAccounts = new Client_21.WhatsappAccountsClient(this._options)));
    }
    get analytics() {
        var _a;
