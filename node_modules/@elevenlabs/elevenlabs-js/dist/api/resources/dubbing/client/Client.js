...
const Client_2 = require("../resources/project/client/Client");
const Client_3 = require("../resources/resource/client/Client");
const Client_4 = require("../resources/transcript/client/Client");
const Client_5 = require("../resources/transcripts/client/Client");
/**
...
class DubbingClient {
    ...
    get project() {
        var _a;
        return ((_a = this._project) !== null && _a !== void 0 ? _a : (this._project = new Client_2.ProjectClient(this._options)));
    }
    get resource() {
        var _a;
        return ((_a = this._resource) !== null && _a !== void 0 ? _a : (this._resource = new Client_3.ResourceClient(this._options)));
    }
    get audio() {
        var _a;
    ...
    get transcript() {
        var _a;
        return ((_a = this._transcript) !== null && _a !== void 0 ? _a : (this._transcript = new Client_4.TranscriptClient(this._options)));
    }
    get transcripts() {
        var _a;
        return ((_a = this._transcripts) !== null && _a !== void 0 ? _a : (this._transcripts = new Client_5.TranscriptsClient(this._options)));
    }
    /**
    ...
    __list() {
        return __awaiter(this, arguments, void 0, function* (request = {}, requestOptions) {
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, "v1/dubbing"),
                method: "GET",
                headers: _headers,
    ...
    __create(request, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (request.mode != null) {
                _body.append("mode", serializers.DubRequestMode.jsonOrThrow(request.mode, { unrecognizedObjectKeys: "strip" }));
            }
            ...
            const _headers = (0, headers_1.mergeHeaders)((_l = this._options) === null || _l === void 0 ? void 0 : _l.headers, (0, headers_1.mergeOnlyDefinedHeaders)(Object.assign({ "xi-api-key": (_p = (_m = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.apiKey) !== null && _m !== void 0 ? _m : (_o = this._options) === null || _o === void 0 ? void 0 : _o.apiKey) !== null && _p !== void 0 ? _p : (_q = process.env) === null || _q === void 0 ? void 0 : _q.ELEVENLABS_API_KEY }, _maybeEncodedRequest.headers)), requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.headers);
            const _response = yield ((_r = this._options.fetcher) !== null && _r !== void 0 ? _r : core.fetcher)({
                url: core.url.join((_t = (_s = (yield core.Supplier.get(this._options.baseUrl))) !== null && _s !== void 0 ? _s : (yield core.Supplier.get(this._options.environment))) !== null && _t !== void 0 ? _t : environments.ElevenLabsEnvironment.Production, "v1/dubbing"),
                method: "POST",
                headers: _headers,
                ...
                timeoutMs: ((_w = (_u = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _u !== void 0 ? _u : (_v = this._options) === null || _v === void 0 ? void 0 : _v.timeoutInSeconds) !== null && _w !== void 0 ? _w : 240) * 1000,
                maxRetries: (_x = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.maxRetries) !== null && _x !== void 0 ? _x : (_y = this._options) === null || _y === void 0 ? void 0 : _y.maxRetries,
                abortSignal: requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.abortSignal,
                fetchFn: (_z = this._options) === null || _z === void 0 ? void 0 : _z.fetch,
                logging: this._options.logging,
            });
            if (_response.ok) {
                return {
    ...
    __get(dubbing_id, requestOptions) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const _response = yield ((_f = this._options.fetcher) !== null && _f !== void 0 ? _f : core.fetcher)({
                url: core.url.join((_h = (_g = (yield core.Supplier.get(this._options.baseUrl))) !== null && _g !== void 0 ? _g : (yield core.Supplier.get(this._options.environment))) !== null && _h !== void 0 ? _h : environments.ElevenLabsEnvironment.Production, `v1/dubbing/${core.url.encodePathParam(dubbing_id)}`),
                method: "GET",
                headers: _headers,
                queryString: core.url.queryBuilder().mergeAdditional(requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.queryParams).build(),
                timeoutMs: ((_l = (_j = requestOptions === null || requestOptions === void 0 ? void 0 : requestOptions.timeoutInSeconds) !== null && _j !== void 0 ? _j : (_k = this._options) === null || _k === void 0 ? void 0 : _k.timeoutInSeconds) !== null && _l !== void 0 ? _l : 240) * 1000,
