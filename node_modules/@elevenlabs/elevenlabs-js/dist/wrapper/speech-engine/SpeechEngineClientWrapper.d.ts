 ...
 * ```
 */
export declare class SpeechEngineClientWrapper extends SpeechEngineClient {
    /**
     ...
     * ```
     */
    create(request: CreateSpeechEngineRequest, requestOptions?: SpeechEngineClient.RequestOptions): Promise<SpeechEngineResource>;
    /**
     ...
     * ```
     */
    get(speechEngineId: string, requestOptions?: SpeechEngineClient.RequestOptions): Promise<SpeechEngineResource>;
    /**
     ...
     * ```
     */
    update(speechEngineId: string, request?: UpdateSpeechEngineRequest, requestOptions?: SpeechEngineClient.RequestOptions): Promise<SpeechEngineResource>;
    /**
     ...
     * ```
     */
    attach(engineId: string, httpServer: HttpServer, path: string, handler: SpeechEngineCallbacks): SpeechEngineAttachment;
}
